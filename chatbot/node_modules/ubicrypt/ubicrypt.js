...
let sign=[ ' ',',','.',';',':','(',')','!','?','%','"',String.fromCharCode(39),'-','/','*','@','^','#','$','~','&','|','<','>','+','=','[',']',String.fromCharCode(10),String.fromCharCode(96),'{','}','_']; // 전처리 코드: 63~95 (33개)
let distance=[63 - 32,64 - 44,65 - 46,66 - 59,67 - 58,68 - 40,69 - 41,70 - 33,71 - 63,72 - 37,73 - 34,74 - 39,75 - 45,
76 - 47,77 - 42,78 - 64,79 - 94,80 - 35,81 - 36,82 - 126,83 - 38,84 - 124,85 - 60,86 - 62,87 - 43,88 - 61,89 - 91,90 - 93,91-10,92-96,93-123,94-125,95-95]; // sign의 전처리코드와 아스키코드 간의 거리
...
module.exports=UBI={
  // 우비 암호화
  Encryption:(string,input_e=0,input_n=0)=>{
    // 일반적인 경우
    ...
    // 이례적으로 (n,e)가 입력으로 온 경우 <neder_block에 위치한 n,e에 해당됨>
    else{
      // 파라미터로 n,e,d 수정
      e=input_e;
      n=input_n;
